 # 🛣️ Freeway Game <a href="https://github.com/Rodolfo-Sampaio/freeway-game/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/react" alt="NPM" align="right"></a>

Guiado pelo instrutor Guilherme Lima, é parte do curso:
### Lógica de programação: laços e listas com JavaScript da [Alura](https://cursos.alura.com.br/course/javascript-listas-lacos) ⭐
Recriamos um jogo clássico onde um personagem tenta atravessar uma rodovia com vários carros em movimento, semelhante ao famoso jogo de cartucho para o Atari 2600. Utilizando a linguagem JavaScript, adicionamos a Biblioteca [p5.collide2D](https://github.com/bmoren/p5.collide2D), que permite detectar colisões entre o personagem e os carros em movimento, proporcionando uma experiência interativa e desafiadora. 🎮💻

<br>

### Layout Desktop
---
![freeway](https://github.com/Rodolfo-Sampaio/freeway-game/assets/96917363/3fc320ea-e3a5-45da-b7c4-4ce66b3b1a61)
